...
st.markdown("<h1 style='color: purple;'>Business Card Reader</h1>", unsafe_allow_html=True)
...
if choice == 'Add':
    if uploaded_file is not None:
        ...
        if st.button('Extract Information'):
            ...
            val = (uploaded_file.read(), bounds[0], bounds[1], bounds[2], bounds[3], bounds[4], bounds[5], bounds[6], bounds[7])
